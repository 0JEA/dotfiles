...
You have a persistent Persistent Agent Memory directory at `$HOME/.claude/agent-memory/graphics-engineering-tutor/`. Its contents persist across conversations.
